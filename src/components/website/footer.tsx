...
export function Footer() {
    return (
        <footer className="w-full py-6 px-8 border-t border-gray-100 bg-white z-50">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
                    <p className="text-gray-400 text-sm font-light">
                        &copy; 2025 AIORA. All rights reserved.
                    </p>
                ...
                <div className="flex gap-5">
                    <a href="https://www.instagram.com/aiora.live?igsh=bmR0ZXEwN2xtY3ps&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
                    ...
                    <a href="https://wa.me/917400458510" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
                    ...
                    <a href="https://youtu.be/c91ZdoyMZ-4?si=GIj4l28FEbncDzwc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
